    ...
    fetch('./../components/navbar/navbar.html')
      ...
      .then(html => {
        ...
        function updateActive() {
          ...
          tabs.forEach(b => {
            if (b.dataset.target === currentPage) b.classList.add('active');
          });
        }
        function wireClicks() {
          const tabs = document.querySelectorAll('.tab-btn');
        ...
        // ===== Auth-aware navbar =====
        const loginBtn = document.querySelector('.tab-btn[data-target="login.html"]');
        const signupBtn = document.querySelector('.tab-btn[data-target="signup.html"]');
        ...
        fetch('/api/auth/me', { credentials: 'include' })
          ...
          .then((me) => {
            ...
            if (me?.role === 'admin' && !adminBtn) {
              ...
              adminBtn.setAttribute('data-target', 'admin.html');
              ...
              membersBtn.setAttribute('data-target', 'members.html');
              membersBtn.textContent = '멤버';
              membersBtn.addEventListener('click', () => (location.href = 'members.html'));
            ...
            async function refreshPending() {
              try {
                const r = await fetch('/api/admin/pending-count', { credentials: 'include' });
